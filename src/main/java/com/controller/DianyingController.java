...
//                            dianyingEntity.setDianyingUuidNumber(data.get(0));                    //电影编号 要改的
...
//                            dianyingEntity.setDianyingVideo(data.get(0));                    //视频 要改的
...
//                            dianyingEntity.setCreateTime(date);//时间
                        ...
                        //查询是否重复
                         //电影编号
                        List<DianyingEntity> dianyingEntities_dianyingUuidNumber = dianyingService.selectList(new EntityWrapper<DianyingEntity>().in("dianying_uuid_number", seachFields.get("dianyingUuidNumber")));
                        if(dianyingEntities_dianyingUuidNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [电影编号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
